...
function SurvivalGuide() {
  ...
  // Function to send the user's message and fetch bot's response
  ...
  return (
    <div>
      {/* Chatbot Icon */}
      <div
        className="select-none fixed flex items-center justify-center bottom-4 right-4 lg:bottom-6 lg:right-6 overflow-hidden w-12 h-12 lg:w-16 lg:h-16 cursor-pointer rounded-full bg-mlsa-bg p-3 border-2 border-mlsa-sky-blue z-50"
        onClick={() => setIsOpen(!isOpen)}
      >
        <img src="/Chatbot.png" alt="Chatbot" className="w-10 h-10 bg-mlsa-bg" />
      </div>
                ...
                >
                  <div
                    className={`p-2 rounded-lg ${
                      msg.role === 'user'
                        ? 'bg-mlsa-sky-blue text-black'
                        : 'border-2 border-mlsa-sky-blue text-white'
                    }`}
                  >
